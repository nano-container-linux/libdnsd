...
// SignString chooses the signing method based on the parameters.
...
// SignPayloadWithPrivateKey signs a payload with an SSH private key.
...
// SignPayloadWithAgent signs a payload using the first available key in the ssh-agent.
